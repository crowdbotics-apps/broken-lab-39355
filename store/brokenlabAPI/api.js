...
function api_v1_buyer_create(payload) {
  return brokenlabAPI.post(`/api/v1/buyer/`, payload.data)
}
...
function api_v1_buyer_update(payload) {
  return brokenlabAPI.put(`/api/v1/buyer/${payload.id}/`, payload.data)
}
function api_v1_buyer_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/buyer/${payload.id}/`, payload.data)
}
...
function api_v1_chat_create(payload) {
  return brokenlabAPI.post(`/api/v1/chat/`, payload.data)
}
function api_v1_chat_retrieve(payload) {
  return brokenlabAPI.get(`/api/v1/chat/${payload.id}/`)
}
function api_v1_chat_update(payload) {
  return brokenlabAPI.put(`/api/v1/chat/${payload.id}/`, payload.data)
}
function api_v1_chat_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/chat/${payload.id}/`, payload.data)
}
...
function api_v1_content_create(payload) {
  return brokenlabAPI.post(`/api/v1/content/`, payload.data)
}
...
function api_v1_content_update(payload) {
  return brokenlabAPI.put(`/api/v1/content/${payload.id}/`, payload.data)
}
function api_v1_content_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/content/${payload.id}/`, payload.data)
}
...
function api_v1_payment_create(payload) {
  return brokenlabAPI.post(`/api/v1/payment/`, payload.data)
}
...
function api_v1_payment_update(payload) {
  return brokenlabAPI.put(`/api/v1/payment/${payload.id}/`, payload.data)
}
function api_v1_payment_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/payment/${payload.id}/`, payload.data)
}
...
function api_v1_plan_create(payload) {
  return brokenlabAPI.post(`/api/v1/plan/`, payload.data)
}
function api_v1_plan_retrieve(payload) {
  return brokenlabAPI.get(`/api/v1/plan/${payload.id}/`)
}
function api_v1_plan_update(payload) {
  return brokenlabAPI.put(`/api/v1/plan/${payload.id}/`, payload.data)
}
function api_v1_plan_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/plan/${payload.id}/`, payload.data)
}
...
function api_v1_portfolio_create(payload) {
  return brokenlabAPI.post(`/api/v1/portfolio/`, payload.data)
}
...
function api_v1_portfolio_update(payload) {
  return brokenlabAPI.put(`/api/v1/portfolio/${payload.id}/`, payload.data)
}
function api_v1_portfolio_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/portfolio/${payload.id}/`, payload.data)
}
...
function api_v1_profile_create(payload) {
  return brokenlabAPI.post(`/api/v1/profile/`, payload.data)
}
...
function api_v1_profile_update(payload) {
  return brokenlabAPI.put(`/api/v1/profile/${payload.id}/`, payload.data)
}
function api_v1_profile_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/profile/${payload.id}/`, payload.data)
}
...
function api_v1_project_create(payload) {
  return brokenlabAPI.post(`/api/v1/project/`, payload.data)
}
...
function api_v1_project_update(payload) {
  return brokenlabAPI.put(`/api/v1/project/${payload.id}/`, payload.data)
}
function api_v1_project_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/project/${payload.id}/`, payload.data)
}
...
function api_v1_rating_create(payload) {
  return brokenlabAPI.post(`/api/v1/rating/`, payload.data)
}
...
function api_v1_rating_update(payload) {
  return brokenlabAPI.put(`/api/v1/rating/${payload.id}/`, payload.data)
}
function api_v1_rating_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/rating/${payload.id}/`, payload.data)
}
...
function api_v1_seller_create(payload) {
  return brokenlabAPI.post(`/api/v1/seller/`, payload.data)
}
...
function api_v1_seller_update(payload) {
  return brokenlabAPI.put(`/api/v1/seller/${payload.id}/`, payload.data)
}
function api_v1_seller_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/seller/${payload.id}/`, payload.data)
}
...
function api_v1_subscription_create(payload) {
  return brokenlabAPI.post(`/api/v1/subscription/`, payload.data)
}
...
function api_v1_subscription_update(payload) {
  return brokenlabAPI.put(`/api/v1/subscription/${payload.id}/`, payload.data)
}
function api_v1_subscription_partial_update(payload) {
  return brokenlabAPI.patch(`/api/v1/subscription/${payload.id}/`, payload.data)
}
